...
;
let blankScryptyFile; //something has gone really wrong if it gets to here
function getMethod(scrypty) {
    switch (os.platform()) {
        case "win32":
            if (scrypty.compile.win != undefined) {
                return scrypty.compile.win.method;
            }
            break;
        case "darwin":
            if (scrypty.compile.mac != undefined) {
                return scrypty.compile.mac.method;
            }
            break;
        case "linux":
            if (scrypty.compile.linux != undefined) {
                return scrypty.compile.linux.method;
            }
            break;
        case "aix":
            if (scrypty.compile.aix != undefined) {
                return scrypty.compile.aix.method;
            }
            break;
        case "freebsd":
            if (scrypty.compile.freebsd != undefined) {
                return scrypty.compile.freebsd.method;
            }
            break;
        case "openbsd":
            if (scrypty.compile.openbsd != undefined) {
                return scrypty.compile.openbsd.method;
            }
            break;
        case "sunos":
            if (scrypty.compile.sunos != undefined) {
                return scrypty.compile.sunos.method;
            }
            break;
        case "android":
            if (scrypty.compile.android != undefined) {
                return scrypty.compile.android.method;
            }
            break;
    }
    ...
    return blankScryptyFile;
}
function getScryptyCommands(scrypty) {
    switch (os.platform()) {
        case "win32":
            if (scrypty.compile.win != undefined) {
                return scrypty.compile.win.commands;
            }
            break;
        case "darwin":
            if (scrypty.compile.mac != undefined) {
                return scrypty.compile.mac.commands;
            }
            break;
        case "linux":
            if (scrypty.compile.linux != undefined) {
                return scrypty.compile.linux.commands;
            }
            break;
        case "aix":
            if (scrypty.compile.aix != undefined) {
                return scrypty.compile.aix.commands;
            }
            break;
        case "freebsd":
            if (scrypty.compile.freebsd != undefined) {
                return scrypty.compile.freebsd.commands;
            }
            break;
        case "openbsd":
            if (scrypty.compile.openbsd != undefined) {
                return scrypty.compile.openbsd.commands;
            }
            break;
        case "sunos":
            if (scrypty.compile.sunos != undefined) {
                return scrypty.compile.sunos.commands;
            }
            break;
        case "android":
            if (scrypty.compile.android != undefined) {
                return scrypty.compile.android.commands;
            }
            break;
    }
    if (scrypty.compile.all != undefined) {
...
function getScryptyOS(scrypty) {
    switch (os.platform()) {
        case "win32":
            if (scrypty.compile.win != undefined) {
                return scrypty.compile.win;
            }
            break;
        case "darwin":
            if (scrypty.compile.mac != undefined) {
                return scrypty.compile.mac;
            }
            break;
        case "linux":
            if (scrypty.compile.linux != undefined) {
                return scrypty.compile.linux;
            }
            break;
        case "aix":
            if (scrypty.compile.aix != undefined) {
                return scrypty.compile.aix;
            }
            break;
        case "freebsd":
            if (scrypty.compile.freebsd != undefined) {
                return scrypty.compile.freebsd;
            }
            break;
        case "openbsd":
            if (scrypty.compile.openbsd != undefined) {
                return scrypty.compile.openbsd;
            }
            break;
        case "sunos":
            if (scrypty.compile.sunos != undefined) {
                return scrypty.compile.sunos;
            }
            break;
        case "android":
            if (scrypty.compile.android != undefined) {
                return scrypty.compile.android;
            }
            break;
    }
    if (scrypty.compile.all != undefined) {
...
function getScryptyFile(scrypty) {
    switch (os.platform()) {
        case "win32":
            if (scrypty.compile.win.mainFile != undefined) {
                return scrypty.compile.win.mainFile;
            }
            break;
        case "darwin":
            if (scrypty.compile.mac.mainFile != undefined) {
                return scrypty.compile.mac.mainFile;
            }
            break;
        case "linux":
            if (scrypty.compile.linux.mainFile != undefined) {
                return scrypty.compile.linux.mainFile;
            }
            break;
        case "aix":
            if (scrypty.compile.aix.mainFile != undefined) {
                return scrypty.compile.aix.mainFile;
            }
            break;
        case "freebsd":
            if (scrypty.compile.freebsd.mainFile != undefined) {
                return scrypty.compile.freebsd.mainFile;
            }
            break;
        case "openbsd":
            if (scrypty.compile.openbsd.mainFile != undefined) {
                return scrypty.compile.openbsd.mainFile;
            }
            break;
        case "sunos":
            if (scrypty.compile.sunos.mainFile != undefined) {
                return scrypty.compile.sunos.mainFile;
            }
            break;
        case "android":
            if (scrypty.compile.android.mainFile != undefined) {
                return scrypty.compile.android.mainFile;
            }
            break;
    }
...
function verifyScrypty(scryptyFile) {
    ...
    for (let i = 0; i < 9; i++) { //since I don't want to repeat the same code for all 3 os's, we just loop through them
        ...
        switch (i) {
            case 0:
                currentOS = scrypty.compile.win;
                currentOSStr = "win32";
                break;
            case 1:
                currentOS = scrypty.compile.mac;
                currentOSStr = "darwin";
                break;
            case 2:
                currentOS = scrypty.compile.linux;
                currentOSStr = "linux";
                break;
            case 3:
                currentOS = scrypty.compile.freebsd;
                currentOSStr = "freebsd";
                break;
            case 4:
                currentOS = scrypty.compile.openbsd;
                currentOSStr = "openbsd";
                break;
            case 5:
                currentOS = scrypty.compile.sunos;
                currentOSStr = "sunos";
                break;
            case 6:
                currentOS = scrypty.compile.android;
                currentOSStr = "android";
                break;
            case 7:
                currentOS = scrypty.compile.aix;
                currentOSStr = "aix";
                break;
            case 8:
                currentOS = scrypty.compile.all;
                currentOSStr = "all";
                break; //all is to be used as a last resort, as we prefer os specific instructions
        }
...
function log(message, severity = 1) {
    ...
    switch (severity) {
        case 1:
            logstr = "[LOG " + date + "] " + message;
            break;
        case 2:
            logstr = "[INFO " + date + "] " + message;
            break;
        case 3:
            logstr = "[WARNING " + date + "] " + message;
            break;
        case 4:
            logstr = "[ERROR " + date + "] " + message;
            break;
    }
